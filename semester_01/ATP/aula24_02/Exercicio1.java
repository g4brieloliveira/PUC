...
//     System.out.println("A soma dos números é: " + sum + "\nO produto dos números é: " + multiplication
//         + "\nA diferença dos números é: " + subtraction + "\nO quociente destes números é: " + division);
//   }
// }
 
// 2. Escreva um programa que leia uma temperatura em graus Farenheit e a imprima em graus 
...
// 5. Escreva um programa que leia uma temperatura em graus Farenheit e a imprima em graus 
// Centígrados. A conversão de graus Farenheit para Centígrados é obtida por C=(5/9)(F-32) 
...
// 6. Determinar a quantidade de litros de combustível gastos em uma viagem por um 
// automóvel que faz 12km/l. Para isso, sabe-se que o tempo gasto na viagem é t = 35min e 
...
// 7. Criar um algoritmo que obtenha 4 números reais e exiba a sua média ponderada, sabendo-
...
//     value = ((num1 * p1) + (num2 * p2) + (num3 * p3) + (num4 * p4)) / (p1 + p2 + p3 + p4);

//     System.out.println("Media: " + value);
//   }
// }

// 8. Para vários tributos a base de calculo é o salário mínimo. Fazer um algoritmo que leia o o 
...
// 9. Todo restaurante cobra 10% sobre o valor do consumo do cliente para o garçom, embora 
...
//     System.out.println("O valor da gorjeta é: R$" + tip + "\nO consumo mais a gorjeta fica igual a: R$" + value);
//   }
// }
 
// 10. Faça um algoritmo para calcular quantas ferraduras são necessárias para equipar todos os 
